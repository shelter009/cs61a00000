...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        ...
        if who == 0:
            if score0 - last_score == 0 and last_score == 0:
                #runningHigh = score1
                return announce_highest(0,score0,0)
            else:
                if score0 - last_score == 0:
                    return announce_highest(0,score0,running_high)
                if score0 - last_score <= running_high:
                    #print('Player 1 gets',score1 - last_score,'points; not enough for a new high')
                    return announce_highest(0,score0,running_high)
                else:
                    print(score0 - last_score,'point(s)! The most yet for Player 0')
                    return announce_highest(0,score0,score0 - last_score)
        else:
            if score1 - last_score == 0 and last_score == 0:
                #runningHigh = score1
                return announce_highest(1,score1,0)
            else:
                if score1 - last_score == 0:
...
def make_averaged(original_function, trials_count=1000):
    ...
    def aaa(*args):
        ...
        for i in range(trials_count):
            sum_dice = sum_dice + original_function(*args)
        #print(sum_dice/1000)
